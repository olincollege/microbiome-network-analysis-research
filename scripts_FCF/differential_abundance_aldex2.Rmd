...
```{r}
rows <- drive_aldex2_on_cluster(phyloseq::subset_samples(ps, cluster == "perturbed" | cluster == "mid"), "p_vs_m")
ALDEx2_results <- rbind(ALDEx2_results, rows)
```
```{r}
rows <- drive_aldex2_on_cluster(phyloseq::subset_samples(ps, cluster == "perturbed" | cluster == "late"), "p_vs_l")
ALDEx2_results <- rbind(ALDEx2_results, rows)
```
```{r}
