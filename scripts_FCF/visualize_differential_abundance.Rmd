...
```{r}
plot_comparative_heat_tree("i_vs_m")
```
```{r}
plot_comparative_heat_tree("i_vs_l")
```
```{r}
plot_comparative_heat_tree("l_vs_m")
```

```{r}
plot_comparative_heat_tree("pG_vs_pM")
```

```{r}
plot_comparative_heat_tree("mC_vs_mM")
```
```{r}
plot_comparative_heat_tree("mC_vs_mG")
```
```{r}
...
```{r}
plot_comparative_heat_tree("lC_vs_lG")
```
```{r}
plot_comparative_heat_tree("lG_vs_lM")
```
```{r}
plot_comparative_heat_tree("lC_vs_lM")
```

## Focused Cluster -- Pair-wise Comparisons to sC

```{r}
plot_comparative_heat_tree("lC_vs_pG")
```
```{r}
# empty, using as key, don't overwrite
plot_comparative_heat_tree("lC_vs_pM")
```

```{r}
plot_comparative_heat_tree("lC_vs_mC")
```
```{r}
plot_comparative_heat_tree("lC_vs_mG")
```
```{r}
plot_comparative_heat_tree("lC_vs_mM")
```
...
```{r}
test_ids <- c("i_vs_m", "i_vs_l", "l_vs_m")
