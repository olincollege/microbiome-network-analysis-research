...
```{r}
# color key
all_cluster_levels <- c("early", "mid C", "late C", 
                        "perturbed G", "mid G", "late G", 
                        "perturbed M", "mid M", "late M",
                        "perturbed", "mid", "late",
                        "not significant")

all_cluster_colors <- c("black", "springgreen3", "springgreen4",
                        "steelblue1", "steelblue3", "steelblue4",
                        "sienna1", "sienna3", "sienna4",
                        "red", "blue", "green",
                        "gray60"
                        )
names(all_cluster_colors) <- all_cluster_levels
```
...
plot_comparative_heat_tree = function(ti) {
  ...
  blank_color <- "oldlace"
  # blank_color <- "gray"
  g1_color <- all_cluster_colors[[group1]]
  g2_color <- all_cluster_colors[[group2]]
...
ALDEx2_results %>%
  filter(level == "focused.cluster") %>%
  ggplot(aes(x=aldex2_effect)) + 
  geom_histogram(binwidth=.5, colour="black", fill="white")
```

```{r}
all_cluster_colors["not significant"]
```
...
get_da_scatter_ALDEx2 <- function(data, test_ids = c(), taxrank = "genus", plot_name="x") {
  ...
  ALDEx2_results_filtered %>%
    ...
    scale_colour_manual(name = 'significant', values = all_cluster_colors) +
...
```{r}
test_ids <- c("lC_vs_e", "lC_vs_mC", "lC_vs_pM", "lC_vs_mM", "lC_vs_lM", "lC_vs_pG", "lC_vs_mG", "lC_vs_lG", 
              "e_vs_mC", "e_vs_pM", "e_vs_mM", "e_vs_lM", "e_vs_pG", "e_vs_mG", "e_vs_lG", 
              "mC_vs_pM", "mC_vs_mM", "mC_vs_lM", "mC_vs_mG", "mC_vs_lG", 
              "pM_vs_mM", "pM_vs_pG", "pM_vs_mG", "pM_vs_lG", 
              "mM_vs_lM", "mM_vs_pG", "mM_vs_mG", "mM_vs_lG", 
              "lM_vs_pG", "lM_vs_mG", "lM_vs_lG", 
              "pG_vs_mG", "pG_vs_lG", 
              "mG_vs_lG")
...
```{r}
test_ids <- c("lC_vs_e", "e_vs_mC", "e_vs_pM", "e_vs_mM", "e_vs_lM", "e_vs_pG", "e_vs_mG", "e_vs_lG")
get_da_scatter_ALDEx2(data = ALDEx2_results, test_ids = test_ids, taxrank = "genus", plot_name=plot_name)
get_da_scatter_ALDEx2(data = ALDEx2_results, test_ids = test_ids, taxrank = "order", plot_name=plot_name)
get_da_scatter_ALDEx2(data = ALDEx2_results, test_ids = test_ids, taxrank = "class", plot_name=plot_name)
```
...
```{r}
test_ids <- c("pM_vs_mM", "pM_vs_pG", "pM_vs_mG", "pM_vs_lG", 
              "mM_vs_lM", "mM_vs_pG", "mM_vs_mG", "mM_vs_lG", 
              "lM_vs_pG", "lM_vs_mG", "lM_vs_lG", 
              "pG_vs_mG", "pG_vs_lG", 
              "mG_vs_lG")
